...
export default function Settings({ onLocaleChange }: SettingsProps) {
  ...
  return (
    <>
      <button
        className="fixed top-4 right-4 z-50 w-10 h-10 grid place-items-center rounded-full bg-[var(--card)] border border-[var(--card-line)] shadow-[var(--shadow)] backdrop-blur-[10px] cursor-pointer text-[var(--ink-soft)] hover:text-[var(--ink)] transition-colors"
