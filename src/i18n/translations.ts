export type Locale = "en" | "ru" | "de" | "uk" | "lv";
...
const lv: Translations = {
  ...
  language: "Valoda",
  detailedMode: "Detalizēti ieteikumi",
  detailedModeDesc: "Audumi, slāņi un stila padomi",
  tagline: "ko patiesībā vilkt mugurā",
  useMyLocation: "Mana atrašanās vieta",
  searchPlaceholder: "vai meklē pilsētu…",
  searchAriaLabel: "Meklēt pilsētu",
  searching: "Meklēju…",
  idleMessage: "Pasaki, kur tu esi, un es pateikšu, ko vilkt mugurā.",
  locating: "Meklēju tevi…",
  loadingWeather: "Lasu debesis…",
  connectionError: "Neizdevās ielādēt laika apstākļus. Pārbaudi savienojumu un mēģini vēlreiz.",
  locationError: "Atrašanās vieta ir izslēgta. Meklē pilsētu.",
  feels: "jūtas kā",
  rain: "lietus",
  humidity: "mitrums",
  iFeelLabel: "Man parasti ir",
  sensitivityAriaLabel: "Temperatūras jutīgums",
  cold: "auksti",
  average: "normāli",
  warm: "karsti",
  ...
  bandCold: "Auksts",
  bandFreezing: "Sals",
  blurbHot: "Ģērbies viegli, sargājies no saules",
  blurbWarm: "Viegli un brīvi",
  blurbMild: "Ērti, varbūt viegls slānis",
  blurbCool: "Laiks vieglai jakai",
  blurbChilly: "Ģērbies slāņos, ņem līdzi jaku",
  blurbCold: "Silts mētelis un cepure",
  blurbFreezing: "Pilna ziemas ekipējums",
  theme: "Tēma",
  themeLight: "Gaišā",
  themeDark: "Tumšā",
  themeSystem: "Sistēma",
  ...
  tshirt: "T-krekls",
  tankTop: "Tops",
  shortSleeveShirt: "Īso piedurkņu krekls",
  longSleeveTop: "Garo piedurkņu krekls",
  lightJacket: "Viegla jaka",
  sweater: "Džemperis",
  jacket: "Jaka",
  warmCoat: "Silts mētelis",
  sweaterCoat: "Džemperis + mētelis",
  heavyWinterCoat: "Ziemas jaka",
  thermalLayersCoat: "Termoveļa + mētelis",
  shorts: "Šorti",
  lightPants: "Vieglas bikses",
  jeans: "Džinsi",
  trousers: "Bikses",
  warmTrousers: "Siltas bikses",
  jeansAndThermals: "Džinsi + termoveļa",
  thermalTrousers: "Siltās bikses",
  lightSneakers: "Vieglas kedas",
  sandals: "Sandales",
  sneakers: "Kedas",
  boots: "Zābaki",
